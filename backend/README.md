...
## Project Structure
    ...
    ├── total_construction_34896  # Django project configurations
...
1. Clone this repo and `cd total_construction_34896`
...
2. Clone this repo and `cd total_construction_34896`
